...
# ------------------------------------
# SHAPE FUNCTION: Spiky Flower Petal
# ------------------------------------
...
# ------------------------------------
def sunset_palette():
    """Soft warm color palette for Solar Bloom style."""
    return [
        (0.98, 0.85, 0.75, 0.45),
        (0.94, 0.78, 0.85, 0.45),
        (0.90, 0.75, 0.95, 0.45),
...
# GENERATIVE FUNCTION
# ------------------------------------
def generate_solar_bloom(seed=4701, n_arms=12, n_layers=5, radius_base=2.0,
                         wobble_min=0.05, wobble_max=0.25, alpha=0.45, bg_color="#ffffff"):
...
fig = generate_solar_bloom(seed, n_arms, n_layers, radius_base, wobble_min, wobble_max, alpha, bg_color)
st.pyplot(fig)
